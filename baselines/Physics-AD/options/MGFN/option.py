...
def parse_args():
    ...
    parser.add_argument('--rgb-list', default='/home/lc/Desktop/wza/gy/dyna/bench/MGFN.-main/datasets/dyna_lists/dyna_hinge-i3d.list', help='list of rgb features ')
    parser.add_argument('--test-rgb-list', default='/home/lc/Desktop/wza/gy/dyna/bench/MGFN.-main/datasets/dyna_lists/dyna_hinge-i3d-test.list', help='list of test rgb features ')
    ...
    parser.add_argument('--gpus', type=str, default='3', help='gpus')
    ...
    parser.add_argument('--obj', default='hinge', help='dataset to train on (default:UCF/XD/UCF-bg-fg-sepa )')
