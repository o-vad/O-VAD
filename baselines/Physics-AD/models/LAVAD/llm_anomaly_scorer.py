...
import os
# import sys
# sys.path.append("F:/workspace/lavad-main/")
from models.LAVAD.llama.llama import Dialog, Llama
...
def parse_args():
    ...
    parser.add_argument("--output_scores_dir", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/scores/raw/llama-2-13b-chat/ctxblabla/")
    parser.add_argument("--output_summary_dir", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/captions/summary/llama-2-13b-chat/tmp/")
    parser.add_argument("--captions_dir", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/captions/clean/tmp/")
    parser.add_argument("--ckpt_dir", type=str, default="F:/workspace/lavad-main/libs/llama/llama-2-13b-chat/")
    parser.add_argument("--tokenizer_path", type=str, default="F:/workspace/lavad-main/libs/llama/tokenizer.model")
