...
from utils.LAVAD_utilities.image_utils import load_images_from_paths
...
class ImageCaptioner:
    ...
    def process_video(self, video):
        ...
        for batch_start_frame in tqdm(
            range(1, video.num_frames+1, self.batch_size * self.frame_interval),
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/captions/raw/blip2-opt-6.7b-coco/")
    parser.add_argument(
        "--dtype",
        type=str,
