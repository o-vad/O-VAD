...
from models.LAVAD.ImageBind.imagebind import data
from models.LAVAD.ImageBind.imagebind.models.imagebind_model import ModalityType
from src.LAVAD.data.video_record import VideoRecord
from utils.LAVAD_utilities.path_utils import find_unprocessed_videos
from utils.LAVAD_utilities.sample_utils import uniform_temporal_subsample
from utils.LAVAD_utilities.torch_utils import initialize_vlm_model_and_device
...
class ImageTextCaptionCleaner:
    ...
    def _prepare_frame_data(self, video, batch_center_frame_idxs, frames_per_clip):
        batch_clip_frame_paths = [
            [
                ...
                for frame_idx in range(
                    max(clip_center_frame - frames_per_clip // 2, 1),
        ...
        batch_frame_idxs = [int(Path(frame_path).stem[-4:]) for frame_path in batch_frame_paths]
...
def parse_args():
    ...
    parser.add_argument("--root_path", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/frames/")
    parser.add_argument("--annotationfile_path", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/annotations/test.txt")
    parser.add_argument("--batch_size", type=int, default=1)
    parser.add_argument("--frame_interval", type=int, default=16)
    parser.add_argument("--output_dir", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/captions/clean/tmp/")
    parser.add_argument("--captions_dir_template", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/captions/raw/{}/")
    parser.add_argument("--index_dir", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/index/tmp/index_flat_ip/")
    parser.add_argument("--resume", action="store_true")
    parser.add_argument("--pathname", type=str, default="*.json")
    parser.add_argument("--imagefile_template", type=str, default="frame_{:04d}.png")
