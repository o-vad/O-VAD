...
def parse_args():
    ...
    parser.add_argument("--captions_dirs", nargs="+", default=["F:/workspace/lavad-main/dataset/lock/norm/right/captions/raw/blip2-opt-6.7b-coco/"])
    parser.add_argument("--output_dir", type=str, default="F:/workspace/lavad-main/dataset/lock/norm/right/index/tmp/index_flat_ip/")
