...
import torch
from utils.mgfn_utils import save_best_record
import os
...
from models.MGFN.mgfn import mgfn
from dataset.mgfn_dataset import Dataset
from src.MGFN.train import train
from src.MGFN.test import test
import datetime
...
def save_config(save_path):
    ...
    for key in vars(args).keys():
        ...
        f.write('\n')
savepath = './ckpt/{}_{}_{}_{}_{}_{}'.format(args.obj, args.feat_extractor, args.lr, args.batch_size,args.mag_ratio,
                                              args.comment)
...
if __name__ == '__main__':
    ...
    torch.save(best_model.state_dict(), 'checkpoints/MGFN/' + args.obj + '_final.pkl')
