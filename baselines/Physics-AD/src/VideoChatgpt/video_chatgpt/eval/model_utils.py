...
def initialize_model(model_name, projection_path=None):
    ...
    vision_tower = CLIPVisionModel.from_pretrained('/home/lc/Desktop/wza/cxt/Video-ChatGPT/clip-vit-large-patch14', torch_dtype=torch.float16,
                                                   low_cpu_mem_usage=True,local_files_only=True).cuda()
