...
def extract_frames(video_path, frames_dir):
    ...
    while cap.isOpened():
        ...
        frame_path = os.path.join(video_frames_dir, f"{frame_:04d}.png")
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        # required=True,
        default = "/home/lc/Desktop/wza/gy/dyna/lavad-main/dataset/zipper/disclose/left",
...
if __name__ == "__main__":
    args = parse_args()
    # video_path = "dataset/lock/norm/right/videos"
    # frame_path = "dataset/lock/norm/right/frames"
    # anno_path = "dataset/lock/norm/right/annotations/test.txt"
