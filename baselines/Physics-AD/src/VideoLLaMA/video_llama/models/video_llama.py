...
class VideoLLAMA(Blip2Base):
    ...
    def from_config(cls, cfg):
        ...
        # 确保ckpt_path是一个具体的文件路径，而不是目录
        #ckpt_path = cfg.get("ckpt", "D:/llm_based_bench/Video-LLaMA-main/path/pretrained_visual_branch_ckpt/VL_LLaMA_2_7B_Pretrained.pth")
        ...
        #ckpt_path_2 = cfg.get("ckpt_2", "D:/llm_based_bench/Video-LLaMA-main/path/pretrained_audio_branch_ckpt/AL_LLaMA_2_7B_Pretrained.pth") 
